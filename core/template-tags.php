		...
		<div class="knd-search__inner">
			<div class="knd-container">
				<form role="search" method="get" class="knd-search__form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
					<input class="knd-search__input" type="search" value="<?php the_search_query(); ?>" name="s" placeholder="<?php esc_attr_e( 'Enter text to search ...', 'knd' ); ?>" aria-label="<?php esc_attr_e( 'Search', 'knd' ); ?>" autocomplete="off">
