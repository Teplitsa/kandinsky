...
( function( blocks, editor, blockEditor, element, components, compose, i18n, serverSideRender ) {
	...
	registerBlockType( 'knd/donations', {
		title: __( 'Leyka Donations' ),
		icon: icon,
		category: 'kandinsky',
		keywords: [ __( 'donation', 'knd' ), __( 'donate', 'knd' ), __( 'leyka', 'knd' ) ],
		supports: {
			align: [ 'wide', 'full' ],
		},
			...
			return (
				el( Fragment, {},
					...
					el( InspectorControls, {},
						...
						el( PanelBody,
							{
								title: __( 'Campaign Settings', 'knd' )
							},
							...
							el( TextControl, {
								...
								onChange: ( val ) => {
									props.setAttributes( { exclude: val } );
								},
							}),
